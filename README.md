...
- [1. H.A.M.L. User Manual (CSE 412 Group Project)](#1-haml-user-manual-cse-412-group-project)
  ...
  - [1.2. stuff U might need](#12-stuff-u-might-need)
  - [1.3. Main Screen](#13-main-screen)
  - [1.4. 1.2 Library](#14-12-library)
    - [1.4.1. `Song Library`](#141-song-library)
    - [1.4.2. `Album Library`](#142-album-library)
    - [1.4.3. `Artist Library`](#143-artist-library)
    - [1.4.4. `Record Label Library`](#144-record-label-library)
  - [1.5. Add](#15-add)
    - [1.5.1. `Add Song`](#151-add-song)
    - [1.5.2. `Add Album`](#152-add-album)
    - [1.5.3. `Add Artist`](#153-add-artist)
    - [1.5.4. 1.3.4 `Add Record Label`](#154-134-add-record-label)
  - [1.6. Search](#16-search)
    - [1.6.1. `Search Song`](#161-search-song)
    - [1.6.2. `Search Album`](#162-search-album)
    - [1.6.3. `Search Artist`](#163-search-artist)
    - [1.6.4. `Search Band`](#164-search-band)
    - [1.6.5. `Search Record Label`](#165-search-record-label)
  - [1.7. Insights](#17-insights)
    - [1.7.1. `Top 10 Songs`](#171-top-10-songs)
    - [1.7.2. `Graph Genre Song By User Rating`](#172-graph-genre-song-by-user-rating)
    - [1.7.3. `Top 10 Albums`](#173-top-10-albums)
    - [1.7.4. `Top 10 Worst Songs`](#174-top-10-worst-songs)
    - [1.7.5. `Top 10 Worst Albums`](#175-top-10-worst-albums)
  - [1.8. Feeling Lucky](#18-feeling-lucky)
    - [1.8.1. `Artists`](#181-artists)
    - [1.8.2. `Songs`](#182-songs)
    - [1.8.3. `Record Label by Album`](#183-record-label-by-album)
    - [1.8.4. `Record Label by Song`](#184-record-label-by-song)
    - [1.8.5. `Record Label by Band`](#185-record-label-by-band)
    - [1.8.6. `Record Label by Instrument`](#186-record-label-by-instrument)
  - [1.9. Theme](#19-theme)
    - [1.9.1. `Theme`](#191-theme)
  - [1.10. Contribution](#110-contribution)
  - [1.11. Developed using PySimpleGUI](#111-developed-using-pysimplegui)
  - [1.12. Known Bugs](#112-known-bugs)
  - [1.13. Repository Scripts](#113-repository-scripts)
    - [1.13.1. `./scripts/clean_db.sh`](#1131-scriptsclean_dbsh)
    - [1.13.2. `./scripts/demo.sh`](#1132-scriptsdemosh)
    - [1.13.3. `./scripts/enter_db.sh`](#1133-scriptsenter_dbsh)
    - [1.13.4. `./scripts/init_db.sh`](#1134-scriptsinit_dbsh)
    - [1.13.5. `python scripts/install.py`](#1135-python-scriptsinstallpy)
    - [1.13.6. `./scripts/refresh_db.sh`](#1136-scriptsrefresh_dbsh)
    - [1.13.7. `./scripts/rm_db.sh`](#1137-scriptsrm_dbsh)
    - [1.13.8. `./scripts/start_db.sh`](#1138-scriptsstart_dbsh)
    - [1.13.9. `./scripts/stop_db.sh`](#1139-scriptsstop_dbsh)
  - [1.14. Postgres Setup](#114-postgres-setup)
    - [1.14.1. `python postgres-setup/csv_generator.py`](#1141-python-postgres-setupcsv_generatorpy)
  - [1.15. How does the database work?](#115-how-does-the-database-work)

## 1.1. Setup
**H.A.M.L. is supported on Linux and macOS, it does not support windows.**

[Interested in what the other shellscripts do?](#113-repository-scripts)
...
### 1.7.2. `Graph Genre Song By User Rating`
...
### 1.8.6. `Record Label by Instrument`
...
## 1.11. Developed using PySimpleGUI
...
## 1.13. Repository Scripts
### 1.13.1. `./scripts/clean_db.sh`
Drops the sql tables from your local version of the database.

```zsh
./scripts/clean_db.sh
```
### 1.13.2. `./scripts/demo.sh`
...
### 1.13.5. `python scripts/install.py`
